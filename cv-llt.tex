...
\leftheader{%
  {\LARGE\bfseries\sffamily Ronit Kumar, B.Sc.}

  \makefield{\faEnvelope[regular]}{\href{mailto:example@gmail.com}{\texttt{ronitkataria450@gmail.com}}}
  \makefield{\faLinkedin}
  {\href{https://www.linkedin.com/in/ronit-kumar-9ba678a7/}{\texttt{Ronit-Kumar}}}

  \makefield{\faPhone[regular]}{\href{mailto:example@gmail.com}{\texttt{(+92 3342542450)}}}
